...
describe('Test Orders', () => {
    ...
    describe('Commands', () => {
        it('Should add a new order...', () => {
            ...
            expect(entity.state.orders[0]).to.deep.include(newOrder1);
            ...
            expect(entity.events[0].constructor.name).to.be.equal('OrderAdded')
        });
        ...
        it('Should get all orders...', () => {
            ...
            expect(entity.state.orders[0]).to.deep.include(newOrder1);
            expect(entity.state.orders[1]).to.deep.include(newOrder2);
    ...
    describe('Events', () => {
        it('Should handle order added events...', () => {
            ...
            function OrderAdded(newOrder) {
                this.userID = newOrder.userID
                this.orderID = newOrder.orderID
                this.items = newOrder.item
            }

            const result = entity.handleEvent(new OrderAdded(newOrder1))
